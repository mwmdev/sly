...
class TestSlideshowCreator:
    ...
    def test_create_slideshow_with_real_images(
        self, mock_input, real_images_dir, real_audio_files
    ):
            ...
            with patch("sly.slideshow.process_images") as mock_process:
                with patch("sly.slideshow.apply_transitions") as mock_transitions:
                    with patch("sly.slideshow.concatenate_videoclips") as mock_concat:
                        ...
                        mock_get_files.return_value = image_paths[
                            :3
                        ]  # Use first 3 real images
                        ...
                        try:
                            ...
                            mock_process.assert_called_once_with(
                                image_paths[:3], 1920, 1080, 3.0
                            )
                            mock_transitions.assert_called_once_with(
                                mock_clips, 1.0, None
                            )
    ...
    def test_create_slideshow_with_soundtrack(
        ...
        try:
            ...
            self.creator.create_slideshow(
                path="./test_images", output=output_path, soundtrack="test_music.mp3"
            )
    ...
    def test_create_slideshow_audio_loop(
        ...
        try:
            # Execute
            self.creator.create_slideshow(
                path="./test_images", output=output_path, soundtrack="short_music.mp3"
            )
    ...
    def test_create_slideshow_no_images_found(self, mock_get_files, mock_input):
        ...
        try:
            ...
            self.creator.create_slideshow(path="./empty_dir", output=output_path)
    ...
    def test_create_slideshow_file_exists_no_overwrite(self, mock_input):
        ...
        try:
            ...
            self.creator.create_slideshow(path="./test_images", output=output_path)
    ...
    @patch("sly.slideshow.get_image_files")
    @patch("sly.slideshow.process_images")
    def test_create_slideshow_processing_error(
        self, mock_process, mock_get_files, mock_input
    ):
