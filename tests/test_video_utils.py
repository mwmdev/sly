...
class TestCreateTitleSlide:
    ...
    def test_create_title_slide_with_custom_font(self, mock_image_clip, mock_truetype, mock_image_new, mock_draw):
        ...
        mock_draw_obj = Mock()
        mock_draw_obj.textbbox.return_value = (0, 0, 100, 50)  # left, top, right, bottom
    ...
    @patch('sly.video_utils.ImageClip')
    def test_create_title_slide_default_font(self, mock_image_clip, mock_load_default, mock_image_new, mock_draw):
    ...
    def test_create_title_slide_font_loading_error(
        self, mock_image_clip, mock_load_default, mock_truetype, mock_image_new, mock_draw
    ):
    ...
    @patch('sly.video_utils.ImageFont.load_default')
    @patch('sly.video_utils.ImageClip')
    def test_create_title_slide_auto_font_size(self, mock_image_clip, mock_load_default, mock_image_new, mock_draw):
...
class TestProcessImages:
    ...
    def test_process_images_basic(
        self, mock_image_clip, mock_resize_crop, mock_rotate, mock_open, mock_image_files
    ):
...
class TestApplyTransitions:
    ...
    def test_apply_transitions_with_title(self, mock_composite, mock_color_clip, mock_clips):
    ...
    @patch('sly.video_utils.ColorClip')
    @patch('sly.video_utils.CompositeVideoClip')
    def test_apply_transitions_title_pause_duration(self, mock_composite, mock_color_clip, mock_clips):
        ...
        assert mock_color_clip.call_count >= 1, "ColorClip should be called for black clips"
