...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument("--image-duration", type=float, default=None, help="Duration of each image in seconds")
    parser.add_argument("--image-order", type=str, default=None, help="Order of images: 'name', 'date', or 'random'")
    parser.add_argument("--transition-duration", type=float, default=None, help="Duration of transition effect in seconds")
    parser.add_argument("--slideshow-width", type=int, default=None, help="Width of the slideshow in pixels")
    parser.add_argument("--slideshow-height", type=int, default=None, help="Height of the slideshow in pixels")
    ...
    parser.add_argument("--font-size", type=int, default=None, help="Font size for the title")
